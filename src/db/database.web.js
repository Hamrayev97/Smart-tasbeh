// expo-sqlite's web implementation depends on window.openDatabase (WebSQL),
// which modern browsers no longer ship. Metro picks this file automatically
// for web builds, backed by AsyncStorage instead so web previews still work.
